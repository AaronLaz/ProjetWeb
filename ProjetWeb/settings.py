...
SECRET_KEY = 'pzx+%!gloaw&!gxsdnehn@6i!-i*-f#%k!9-0e4_o$n(heef3w'
...
ROOT_URLCONF = 'ProjetWeb.ProjetWeb.urls'
...
AUTH_USER_MODEL = 'account.Account' # overrides default user object behavior
